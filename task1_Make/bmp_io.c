 ...
 *
 * @param bmp_path Путь до файла изображения в формате BMP
 *
...
/**
 * @brief Метод для извлечения данных заголовков BMP-файла
 *
 * @param header Заголовок изображения в формате BMP
 * @param buf Буфер
 *
 * @return static void
 */
...
/**
 * @brief Метод для подготовки заголовка BMP-файла
 *
 * @param header Заголовок изображения в формате BMP
 * @param buf Буфер
 *
 ...
 *
 * @param bmp_file Файл изображения в формате BMP
 * @param bmp_path Путь до файла изображения в формате BMP
 *
 * @return static void
 */
